<%@ Page Title="租房客登录" MasterPageFile="~/Site.Master" Async="true"  Language="C#" AutoEventWireup="true" CodeFile="TenantLogin.aspx.cs" Inherits="Tenant_TenantLogin" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    <a href="TenantRegister.aspx">注册</a>
                    如果你没有本地帐户。
                </p>
            </section>
        </div>
