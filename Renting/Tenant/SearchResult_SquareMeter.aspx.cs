...
public partial class Tenant_SearchResult_Price : System.Web.UI.Page
{
    ...
    public string getSearchResult()
    {
        ...
        sqlDataReader = sqlData.GetDataReader(@"select * from  House where SquareMeter < '" + Request["QueryKey"] + "' ");
