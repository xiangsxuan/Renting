<%@ Page Title="房主登录" MasterPageFile="~/Site.Master" Async="true"  Language="C#" AutoEventWireup="true" CodeFile="OwnerLogin.aspx.cs" Inherits="Tenant_TenantLogin" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    <a href="OwnerRegister.aspx">注册</a>
                    如果你没有本地帐户。
                </p>
            </section>
        </div>
